 ...
 *
 *  1. Run `download-places-osm.ts --regions=lausanne,nyon,vevey_city,neuchatel,la_chaux_de_fonds,bern,zurich,thun` to
...
function parseArgs(argv: string[]): Cli {
  ...
  let regions = "lausanne,morges,nyon,vevey,vevey_city,neuchatel,la_chaux_de_fonds,bern,zurich,thun,geneve";
