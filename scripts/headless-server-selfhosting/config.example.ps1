...
# Utilise pour récupérer vos clés SSH publiques depuis https://github.com/<GitHubUser>.keys
$GitHubUser = "your-github-username"

# Nom court de la machine headless (sans domaine).
# Ce nom sera utilisé comme hostname dans Tailscale et pour se connecter en SSH.
...
# Coordonnées du repo GitHub qui contient le script de bootstrap Tailscale+OpenSSH.
# Ne modifiez ces valeurs que si vous avez forké le repo.
...
# "main" est pratique mais mutable  - pour un usage en production, privilégiez
# un tag de release ou un SHA complet pour garantir la reproductibilité.
$BootstrapRef = "main"
